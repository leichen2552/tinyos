...
int main()
{
	...
	tTaskInit(&tTaskIdle, idleTaskEntry, (void *)0, TINYOS_PRO_COUNT -1,&idleTasEnv[1024]);
	idleTask = &tTaskIdle;
	nextTask = tTaskHighsetReady();

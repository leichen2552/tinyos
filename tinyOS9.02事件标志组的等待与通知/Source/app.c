...
void task2Entry(void * param)
{
    ...
    for(;;)
	{	
		tFlagGroupWait(&flagGroup1, TFLAGGROUP_CLEAR_ALL | TFLAGGROUP_CONSUME, 0x04, &resultFlags, 10);
		tFlagGroupNoWaitGet(&flagGroup1, TFLAGGROUP_CLEAR_ALL, 0x03, &resultFlags);
